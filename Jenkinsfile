// Define repository
def username = 'mkolman'
def litecoin_repo = "https://github.com/${username}/litecoin.git"
...
properties([
  parameters([
    ...
    // Image repo tag
    string(name: 'image_repo_tag', description: 'Full Docker image name with repository included.', defaultValue: "${username}/litecoin"),
    // Kube config
